    ...
    item.addEventListener('click', function () {
        ...
        switch (projectId) {
            ...
            case '8':
                ...
                break;
            case '9':
                window.open('https://insantomgmc.github.io/Cargo/', '_blank');
                break;
            case '10':
                window.open('https://insantomgmc.github.io/Landing-Italy/', '_blank');
                break;
            case '11':
                window.open('https://insantomgmc.github.io/Armani/', '_blank');
                break;
            case '12':
                window.open('https://insantomgmc.github.io/Jean-semenov/', '_blank');
                break;
            case '13':
                window.open('https://pythonlib.ru/', '_blank');
                break;
            default:
...
function paralax(e) {
    document.querySelectorAll('.paralax-img-container').forEach(function (move) {
        var moving_val = move.getAttribute('data-value');
        var x = e.clientX * moving_val / 200;
        var y = e.clientY * moving_val / 200;
